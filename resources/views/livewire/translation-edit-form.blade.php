    ...
    <div class="text-base grid">
        @foreach ($locales as $locale)
            ...
            <div class="flex items-center" x-data="{
                ...
                <label class="w-16 font-bold" for="{{ $id }}" x-ref="label" x-bind:tabindex="!editing && '0'"
                    @focus="openForm">
                    {{ $locale }}:
                </label>
                ...
                <div class="block w-full flex items-center space-x-2" x-show="editing">
                    ...
                    <div class="flex items-center align-center">
                        <button @click="closeWithCancel">
                            <x-filament::icon alias="filament-chained-translation-manager::cancel-translation"
                                icon="heroicon-o-x-mark" class="w-5 h-5 text-danger-500" />
                        </button>
                    </div>
                </div>
            </div>
